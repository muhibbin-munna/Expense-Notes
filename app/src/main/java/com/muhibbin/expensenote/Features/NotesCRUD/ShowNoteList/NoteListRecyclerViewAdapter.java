...
import com.muhibbin.expensenote.Features.NotesCRUD.UpdateNoteInfo.NoteUpdateDialogFragment;
import com.muhibbin.expensenote.Features.NotesCRUD.UpdateNoteInfo.NoteUpdateListener;
...
public class NoteListRecyclerViewAdapter extends RecyclerView.Adapter<CustomViewHolder> {

    private Context context;
    private List<Note> noteList;
    private DatabaseQueryClass databaseQueryClass;

    public NoteListRecyclerViewAdapter(Context context, List<Note> noteList) {
